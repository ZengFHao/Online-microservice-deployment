...
class Agent(parl.Agent):
    ...
    def sample(self, obs):
        ...
        if sample < self.e_greed:
            ...
            while flag[act] == 1 or flag_temp[act % changeContainerNumber] == 1:  #如果动作已经被选择过，则重新随机选择一个动作，直到找到一个未被选择的动作。
    ...
    def predict(self, obs):
        ...
        pred_q1 = self.alg.predict(obs)     #根据观测值 obs 预测每个可能动作的 Q 值，返回一个数组
